...
3. Application and REST tests cover passing and failing derived summaries. The slice remains bounded: provider-backed integration connectivity, historical diagnostic time series, and richer provider error details remain pending BRG-111 work.
